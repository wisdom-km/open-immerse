...
/** Top-level enableThinking (default false). Translation stays fast unless the user opts in. */
export function isThinkingEnabled(settings) {
  return settings?.enableThinking === true;
}

/**
 * Ark / OpenAI-compat thinking controls for Chat Completions (and Responses if used).
