...
/**
 * Paint masked pixels paper-white. Glyph-box pixels stay, and so does dark ink
 * touching them. A radical tip is drawn outside the font box and can fall in
 * the next line's item box; that stroke stays. Detached neighbor ink still goes.
 */
