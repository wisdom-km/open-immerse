(function (root) {
  ...
  const OIBilingual = {
    ...
    /**
     * TRIAD §C.3: visible border-box from getBoundingClientRect.
     * Do not derive indent from text-indent — parent padding/margin or a nested column.
     */
     ...
     * not indented body paragraphs (TRIAD §C.3).
     */
