(function (root) {
  ...
  const OIBilingual = {
    ...
    HEADING_TARGET_MIN_EM: 0.35,
    HEADING_TARGET_EM: 0.45,
    HEADING_TARGET_MAX_EM: 0.55,
    HEADING_HARD_MAX_EM: 0.7,
     ...
     * Headings: target 0.35–0.55em, must tighten if > 0.7em or > 14px.
