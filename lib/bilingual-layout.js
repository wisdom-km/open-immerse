(function (root) {
  ...
  const OIBilingual = {
    ...
    HEADING_MARGIN_TOP_EM: 0.15,
    HEADING_PAD_TOP_EM: 0.35,
    HEADING_PAD_MIN_EM: 0.2,
    HEADING_TARGET_MIN_EM: 0.25,
    HEADING_TARGET_EM: 0.35,
    HEADING_TARGET_MAX_EM: 0.45,
    HEADING_HARD_MAX_EM: 0.55,
    HEADING_HARD_MIN_EM: 0.2,
    HEADING_HARD_MAX_PX: 14,
    /** BILINGUAL-SPACING §8 / BODY-HEADING-GLOSS-SIZE: heading gloss vs body translation. */
    ...
    bodyPullCapPx(fontSize) {
      const fs = OIBilingual.fontSizePx(fontSize);
      const raw = (OIBilingual.BODY_MARGIN_TOP_EM - OIBilingual.BODY_MARGIN_FLOOR_EM) * fs;
     ...
     * Headings: §7 target 0.25–0.45em, must tighten if > 0.55em or > 14px.
     * Body: keep ~0.4em via −0.65em; extra pull stays within −0.8em.
     */
