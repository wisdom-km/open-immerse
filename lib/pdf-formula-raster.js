...
import { CROP_SCALE, rasterCropRect } from "./pdf-blocks.js";
import { displayFormulaMinEm, inlinePaintBox } from "./pdf-formula-size.js";
...
export function formulaDisplayCssSize({
  ...
  if (inline && !promoted) {
    ...
    const minEm = displayFormulaMinEm(block.inkShare, block.scriptShare, font);
