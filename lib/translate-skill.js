...
- Titles: prefer tight, verb-led Chinese faithful to "taught us about". FORBID these heading calques: 「让我们了解到」「让我们了解到的」「关于…哪些内容」. Never render "What X taught us about Y" as 「X让我们了解到了关于Y的哪些内容」.
...
When the target is Chinese, titles and headings must stay tight and verb-led. FORBID these calques: 「让我们了解到」「让我们了解到的」「关于…哪些内容」. If the draft uses them, rewrite into concise verb-led Chinese faithful to "taught us about" — do not invent meaning.
