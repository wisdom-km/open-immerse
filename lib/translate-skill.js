 ...
 *
 * Optional second pass: top-level `twoStepPolish` (boolean, default false).
 * When false/undefined: single-pass Skill only.
...
export const TRANSLATION_SKILL_CONTRACT = [
  ...
  "Default remains single-shot (twoStepPolish=false) to save tokens. Custom prompt skips polish."
].join(" ");
...
/**
 * Top-level `twoStepPolish` (default false). Custom prompt skips the polish pass.
