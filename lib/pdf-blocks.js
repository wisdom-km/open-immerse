...
/**
 * Hard floor for display ink height / right-pane body font-size.
 * The crop box is taller than the ink (#62 keeps a paper margin), so the
 * CSS min-height sits above this floor. 2.25em × ~0.8 ink share ≈ 1.8.
 */
export const DISPLAY_INK_FLOOR = 1.8;
export const DISPLAY_CROP_MIN_HEIGHT_EM = 2.25;
 ...
 * em floor, grow only enough for min-height — not straight to 100%.
 */
