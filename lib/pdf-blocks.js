...
/** Exclusive display prefers measured ink ≥ 1.2× body. The 1.6 floor stays the strong band. */
export const DISPLAY_INK_PREFER = 1.2;
 ...
 * ink under 1.2× grows only this floor — column width stays first.
 */
