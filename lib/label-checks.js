 ...
 * the selector's own font tag. A3 compares element sets. A4 is the share
 * of formula units below the pre-label confidence floor, and, for the
 * baseline selector, the share of units that produced an empty SVG.
 */
