...
/** H1 in these ancestors is a rail/menu label, not the article hero title. header / banner stay allowed. */
export const PRIMARY_TITLE_SKIP_ANCESTOR = [
  "nav",
  "aside",
  "footer",
  "[role='navigation']",
...
/** Pure chrome still skipped in page scope: top nav, menus, footer piles, cookies. Not side rails. */
export const PAGE_TOP_NAV_SELECTOR = [
  "header nav",
  "[role='banner'] nav",
...
export const PAGE_CHROME_SELECTOR = [
...
/** Article-scope chrome detector (nav / aside / Claude rails). Callers must not apply this when translateScope === "page". */
